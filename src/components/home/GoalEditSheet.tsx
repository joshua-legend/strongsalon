...
const CATEGORIES: { value: GoalCategory; label: string }[] = [
  { value: "strength", label: "근력" }, { value: "body", label: "체성분" },
  { value: "cardio", label: "체력" }, { value: "attendance", label: "출석" },
  { value: "weight", label: "체중" },
];

const EXERCISE_OPTIONS = [
  { key: "bench", label: "벤치프레스" }, { key: "squat", label: "스쿼트" },
  { key: "deadlift", label: "데드리프트" }, { key: "ohp", label: "오버헤드프레스" },
];

const DEADLINE_OPTIONS = [
  { months: 1, label: "1개월" }, { months: 2, label: "2개월" }, { months: 3, label: "3개월" },
];
