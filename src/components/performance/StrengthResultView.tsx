  ...
  return (
    <div className="px-4 py-6 flex flex-col min-h-[60vh]">
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <p className="font-mono text-sm text-neutral-500">추정 1RM: {result.estimated1RM.toFixed(1)} kg</p>
        <p className="font-mono text-sm text-neutral-500">체중 대비: {result.bodyweightRatio.toFixed(2)}배</p>
      ...
      {prevResult && sameEquipment && prev1RM > 0 && (
        <div className="rounded-xl p-4 bg-neutral-900 border border-neutral-800 mb-6">
          ...
          <p className="text-sm text-neutral-400">{prevResult.estimated1RM.toFixed(1)}kg (1RM)</p>
